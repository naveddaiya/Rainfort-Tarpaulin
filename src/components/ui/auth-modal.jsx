...
export function AuthModal({ isOpen, onClose, redirectMessage }) {
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      <div className={cn(
        "relative w-full max-w-sm bg-background border-2 border-border rounded-2xl heavy-shadow",
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex flex-col items-center text-center space-y-3">
            <div className="p-4 rounded-full border-2 border-border bg-muted/30">
              <ShieldCheck className="h-8 w-8" style={{ color: '#1a4d7a' }} />
            </div>
            <div>
              <h2 className="text-xl font-bold uppercase tracking-wider">Sign In Required</h2>
              <p className="text-sm text-muted-foreground mt-1">
                {redirectMessage || 'Please sign in to place your order.'}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-2 text-sm text-muted-foreground">
            {[
              ...
              'Pre-filled checkout with your details',
              'Order history & reorder easily',
            ].map(b => (
